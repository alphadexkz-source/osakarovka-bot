...
const CATEGORIES = ['магазин','аптека','кафе','столовая','банк','школа','больница','парикмахерская','автосервис','заправка','рынок','гостиница','салон','стоматология','ветеринар','детский сад','ресторан','продукты','одежда','обувь'];
