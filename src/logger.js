...
// Явный вызов из index.js вместо автоматического сайд-эффекта при require
...
const log = {
  ...
  // Предупреждение → stdout + errors.log (через патч, если initFileLogging вызван)
  warn: (module, msg, extra = {}) =>
    console.warn(fmt('WARN', module, { msg, ...extra })),

  // Ошибка → stdout + errors.log (через патч, если initFileLogging вызван)
