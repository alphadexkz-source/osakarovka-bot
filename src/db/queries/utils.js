...
const ALLOWED_DRIVER_COLS  = new Set(['full_name','car_make','car_plate','car_color','status','rating','rating_count','queue_position','order_balance','skip_next','last_activity'])
const ALLOWED_TARIFF_COLS  = new Set(['name','keywords','day_price','night_price','description','is_active'])
const ALLOWED_ORDER_COLS   = new Set(['driver_id','status','cancel_reason','accepted_at','arrived_at','completed_at','cancelled_at','is_free','scheduled_time','scheduled_reminder_sent'])
